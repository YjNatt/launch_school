...
// When arrays are used with the binary plus operator
// Both arrays are turned to string then they are concatenated
// On line 41 the the return value of using the binary plus operator
// on 3 functions is a string of an adjective, firstNoun, and secondNoun
// Then on line 44 the program tries to invoke the Array function 'join'
// however `dishName` is a string so it throws a type error
